...
const index_1 = require("sofamaxxing/dist/index");
const animeParadise = new index_1.AnimeParadise();
const routes = (fastify) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    fastify.get("/:query", (request, reply) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        try {
            const result = yield animeParadise.search(query);
    ...
    fastify.get("/info/:id", (request, reply) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        try {
            const result = yield animeParadise.fetchInfo(id);
            return reply.status(200).send(result);
        }
        catch (err) {
    ...
    fastify.get("/episode/*", (request, reply) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        try {
            const result = yield animeParadise.fetchSources(episodeId);
            return reply.status(200).send(result);
        }
        catch (err) {
